...
public class SignItemRecyclerView extends RecyclerView {
    ...
    public SignItemRecyclerView(@NonNull Context context) {
        this(context,null);
    }

    public SignItemRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SignItemRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                SignAdapter.ViewHolder viewHolder = (SignAdapter.ViewHolder) getChildViewHolder(view);

                mItemLayout = viewHolder.cardView;
